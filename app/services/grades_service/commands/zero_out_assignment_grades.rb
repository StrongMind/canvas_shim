module GradesService
  module Commands
    class ZeroOutAssignmentGrades
      ...
      def call!
        return if @submission.workflow_state == 'submitted'
        return if @submission.workflow_state == 'graded'
        return unless @submission.score.nil?
        return unless @submission.grade.nil?
        return unless @submission.due_at < 1.hour.ago
